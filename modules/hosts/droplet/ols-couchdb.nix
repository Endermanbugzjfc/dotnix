...
# https://github.com/NixOS/nixpkgs/blob/3aadb7ca9eac2891d52a9dec199d9580a6e2bf44/nixos/modules/services/databases/couchdb.nix
# to work with (single-user) Home configurations.

{
  flake.homeModules.couchdb = {
    config,
    options,
    lib,
    pkgs,
