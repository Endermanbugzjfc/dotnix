{
  ...
  buildNimPackage' = buildNimPackage.override {
    nim2 = nim-1_0; # Intended for Nim 1, but resolves to Nim 2 because of "nim >= 1.6.2".
  };
  ...
  faupack = buildNimPackage' {
    ...
    src = fau;
    lockFile = ./fau_lock.json;
  };

  fauLock = builtins.fromJSON (builtins.readFile ./fau_lock.json);
  partialLock = builtins.fromJSON (builtins.readFile ./package_lock.partial.json);
  lockFile = writeText "package_lock.json" (builtins.toJSON {
