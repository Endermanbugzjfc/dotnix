...
Pinning usually applies onto packages ("bulky installations") that require a long installation or compile time are considered bulky and will be packaged as separate flakes under this directory.
